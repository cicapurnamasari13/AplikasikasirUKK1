	   ...
	   <div class="page custom-index">
		...
		<div class="main-footer ht-45">
			<div class="container-fluid pd-t-0-f ht-100p">
				<span> Copyright © 2022 <a href="javascript:void(0);" class="text-primary">Azira</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0);"> Cica </a> All rights reserved.</span>
			</div>
		</div>
		<!-- Footer closed -->
	</div>
