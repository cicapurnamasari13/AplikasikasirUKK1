			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							<li class="slide">
							<a class="side-menu__item {{ request()->is('pelanggan')? 'active':'' }}" href="{{ route('pelanggan.index') }}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Pelanggan</span></a>
							</li>	
						</ul>

						<ul class="side-menu ">
							<li class="slide">
							<a class="side-menu__item {{ request()->is('produk')? 'active':'' }}" href="{{ route('produk.index')}}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Produk</span></a>
							</li>	
						</ul>

						<ul class="side-menu ">
							<li class="slide">
							<a class="side-menu__item {{ request()->is('penjualan')? 'active':'' }}" href="{{ route('penjualan.index')}}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Penjualan</span></a>
							</li>	
						</ul>

						<ul class="side-menu ">
							<li class="slide">
							<a class="side-menu__item {{ request()->is('detail_penjualan')? 'active':'' }}" href="{{ route('detail_penjualan.index')}}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Detail Penjualan</span></a>
							</li>	
						</ul>
